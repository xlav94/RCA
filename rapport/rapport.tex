...
The interactive HTML version of Figure~\ref{fig:weights} was generated using Plotly. It can be accessed separately via the following local file:
\href{run:../src/plots/portfolio_weights_interactive_20260314-223522.html}{src/plots/portfolio\_weights\_interactive\_20260314-223522.html}.


\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\linewidth]{../src/plots/portfolio_weights.png}
    \caption{Static view of the portfolio allocation over time.}
    \label{fig:weights}

    \vspace{0.5cm}

    \includegraphics[width=0.95\linewidth]{../src/plots/cumulative_return_20260314-231915.png}
    \caption{Cumulative return of the PPO agent compared with the buy-and-hold benchmark.}
    \label{fig:returns}
\end{figure}
...
\section{Allocation Optimization Formulations}
$w$ = portfolio weights vector\\
$\mu$ = expected returns vector (actions)\\
...
\textbf{Modern Portfolio Theory Mean-variance Optimization} \\
Quadratic Utility Function:
$-\left[ w^T \mu - \frac{1}{2} \lambda (w^T \Sigma w) \right]$ \\

\textbf{Post Modern Portfolio Theory Mean Semi-deviation Optmization} \\
Mean-Semideviation Utility Function:
$-\left[ w^T \mu - \lambda \sqrt{\frac{1}{N} \sum_{t=1}^{N} \min(0, r_t^T w)^2 + \epsilon} \right]$ \\
...
\begin{table}[h!]
    \centering
    \caption{Breakdown of portfolio assets by sector.}
