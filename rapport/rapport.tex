...
\textbf{Post Modern Porfolio Theory Mean Semi-deviation Optmization} \\
...
\textit{Using de Jacobian for the optimization is 27\% faster than without it during the training process.}
\newpage
